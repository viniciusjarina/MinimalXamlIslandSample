...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        ::SetWindowPos(_hWndXamlIsland, NULL, 20, 20, windowRect.right - windowRect.left - 20, windowRect.bottom - windowRect.top - 20, SWP_SHOWWINDOW);
    
        _xamlButton = winrt::Windows::UI::Xaml::Controls::Button();
        _xamlButton.Content(winrt::box_value(L"Button"));

        _desktopWindowXamlSource.Content(_xamlButton);
    }
    break;
    case WM_COMMAND:
        {
